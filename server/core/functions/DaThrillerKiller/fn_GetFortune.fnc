/*Server side so we can continue adding a whole shit load of sayings and just because theres really no need for it to be client side*/
/*also prevest fuck boys from stealing my code because they dont know how to do shit themselfs*/

private ["_Cookie","_messages"];
...
_Cookie = _messages call BIS_selectRandom;

[_this,_Cookie,"dtk_MyCookie",true,false]call network_MPExec;