private["_art","_sleepTime","_item","_anzahl","_maxanzahl","_hungerStillen"];
_art = _this select 0;
...
_maxanzahl =   [player,_item] call storage_amount;
_hungerStillen = 0;
...
switch _item do 
	{	
		...
		case "cl_donut":     { _hungerStillen = 10;  };
		...
		case "cookie":     { _hungerStillen = 4;  ["SERVER",player,"S_dtk_GetFortune",false,false]call network_MPExec;};
	};
...
systemChat  format[localize "STRS_inv_item_nahrung_gegessen", ((round (100-INV_hunger)) call string_intToString)];
};
